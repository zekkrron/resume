...
\cvHeadingStart
  ...
  \cvItemStart
    ...
    \cvitem{Created an intuitive \textbf{Streamlit} interface that supports smooth user interactions and delivers real-time responses for a seamless experience}
  \cvItemEnd
\cvHeadingEnd
